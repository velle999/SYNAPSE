 ...
 *
 * The colour is now the strip palette's glyph rather than a hardcoded #05d9e8. Those are the
...
Rectangle {
    ...
    color: mouse.containsMouse || MenuState.open ? root.pal.hoverBg : "transparent"
