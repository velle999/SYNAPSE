...
"
  ...
  ["Malware Scan — a weekly ClamAV sweep"]="मैलवेयर जाँच — हर हफ़्ते ClamAV से"
  ...
  ["Summary"]="सारांश"
  ["Install"]="स्थापना"
  ["the installer's own media"]="इंस्टॉलर का अपना मीडिया"
  ["%1 GiB — SynapseOS needs at least %2 GiB"]="%1 GiB — SynapseOS को कम से कम %2 GiB चाहिए"
