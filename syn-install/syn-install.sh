...
while :; do
    ...
    SEL_CORE="synapd synsh synnet synguard synui synapse_kmod syn syn-model syn-firstboot syn-update synpkg synfiles syn-settings fetch"
  ...
  desktop features will not work as documented."
                ...
                SEL_CORE="syn syn-model syn-firstboot synpkg synfiles syn-settings"
