...
"
  ...
  ["Malware Scan — a weekly ClamAV sweep"]="マルウェアスキャン — 毎週の ClamAV 検査"
  ...
  ["Remote desktop — reach this machine from another"]="リモートデスクトップ — このマシンに別のマシンから接続"
  ["Arsenal — BlackArch browser"]="Arsenal — BlackArch ブラウザー"
  ["Speech engine — dictation and voice (~900 MB)"]="音声エンジン — 音声入力と読み上げ (~900 MB)"
  ...
  ["Summary"]="確認"
  ["Install"]="インストール"
  ["the installer's own media"]="インストーラー自身のメディア"
  ["%1 GiB — SynapseOS needs at least %2 GiB"]="%1 GiB — SynapseOS には最低 %2 GiB 必要です"
