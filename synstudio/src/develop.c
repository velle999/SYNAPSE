...
static const field fields[] = {
     ...
     * meaning of. */
    D("log",              F_INT,   log_in,           0.0f,       2.0f, N_("Basic"), N_("Log input")),
    D("temp",             F_FLOAT, temp_k,           0.0f,   50000.0f, N_("Basic"), N_("Temperature")),
    D("tint",             F_FLOAT, tint,          -150.0f,     150.0f, N_("Basic"), N_("Tint")),
    D("exposure",         F_FLOAT, exposure,        -8.0f,       8.0f, N_("Basic"), N_("Exposure")),
    D("contrast",         F_FLOAT, contrast,      -100.0f,     100.0f, N_("Basic"), N_("Contrast")),
    D("highlights",       F_FLOAT, highlights,    -100.0f,     100.0f, N_("Basic"), N_("Highlights")),
    D("shadows",          F_FLOAT, shadows,       -100.0f,     100.0f, N_("Basic"), N_("Shadows")),
    D("whites",           F_FLOAT, whites,        -100.0f,     100.0f, N_("Basic"), N_("Whites")),
    D("blacks",           F_FLOAT, blacks,        -100.0f,     100.0f, N_("Basic"), N_("Blacks")),
    D("texture",          F_FLOAT, texture,       -100.0f,     100.0f, N_("Presence"), N_("Texture")),
    D("clarity",          F_FLOAT, clarity,       -100.0f,     100.0f, N_("Presence"), N_("Clarity")),
    D("dehaze",           F_FLOAT, dehaze,        -100.0f,     100.0f, N_("Presence"), N_("Dehaze")),
    D("vibrance",         F_FLOAT, vibrance,      -100.0f,     100.0f, N_("Presence"), N_("Vibrance")),
    D("saturation",       F_FLOAT, saturation,    -100.0f,     100.0f, N_("Presence"), N_("Saturation")),
    D("hsl.red.hue",      F_FLOAT, hsl_hue[0],    -100.0f,     100.0f, N_("Colour mixer"), N_("Red hue")),
    D("hsl.orange.hue",   F_FLOAT, hsl_hue[1],    -100.0f,     100.0f, N_("Colour mixer"), N_("Orange hue")),
    D("hsl.yellow.hue",   F_FLOAT, hsl_hue[2],    -100.0f,     100.0f, N_("Colour mixer"), N_("Yellow hue")),
    D("hsl.green.hue",    F_FLOAT, hsl_hue[3],    -100.0f,     100.0f, N_("Colour mixer"), N_("Green hue")),
    D("hsl.aqua.hue",     F_FLOAT, hsl_hue[4],    -100.0f,     100.0f, N_("Colour mixer"), N_("Aqua hue")),
    D("hsl.blue.hue",     F_FLOAT, hsl_hue[5],    -100.0f,     100.0f, N_("Colour mixer"), N_("Blue hue")),
    D("hsl.purple.hue",   F_FLOAT, hsl_hue[6],    -100.0f,     100.0f, N_("Colour mixer"), N_("Purple hue")),
    D("hsl.magenta.hue",  F_FLOAT, hsl_hue[7],    -100.0f,     100.0f, N_("Colour mixer"), N_("Magenta hue")),
    D("hsl.red.sat",      F_FLOAT, hsl_sat[0],    -100.0f,     100.0f, N_("Colour mixer"), N_("Red saturation")),
    D("hsl.orange.sat",   F_FLOAT, hsl_sat[1],    -100.0f,     100.0f, N_("Colour mixer"), N_("Orange saturation")),
    D("hsl.yellow.sat",   F_FLOAT, hsl_sat[2],    -100.0f,     100.0f, N_("Colour mixer"), N_("Yellow saturation")),
    D("hsl.green.sat",    F_FLOAT, hsl_sat[3],    -100.0f,     100.0f, N_("Colour mixer"), N_("Green saturation")),
    D("hsl.aqua.sat",     F_FLOAT, hsl_sat[4],    -100.0f,     100.0f, N_("Colour mixer"), N_("Aqua saturation")),
    D("hsl.blue.sat",     F_FLOAT, hsl_sat[5],    -100.0f,     100.0f, N_("Colour mixer"), N_("Blue saturation")),
    D("hsl.purple.sat",   F_FLOAT, hsl_sat[6],    -100.0f,     100.0f, N_("Colour mixer"), N_("Purple saturation")),
    D("hsl.magenta.sat",  F_FLOAT, hsl_sat[7],    -100.0f,     100.0f, N_("Colour mixer"), N_("Magenta saturation")),
    D("hsl.red.lum",      F_FLOAT, hsl_lum[0],    -100.0f,     100.0f, N_("Colour mixer"), N_("Red luminance")),
    D("hsl.orange.lum",   F_FLOAT, hsl_lum[1],    -100.0f,     100.0f, N_("Colour mixer"), N_("Orange luminance")),
    D("hsl.yellow.lum",   F_FLOAT, hsl_lum[2],    -100.0f,     100.0f, N_("Colour mixer"), N_("Yellow luminance")),
    D("hsl.green.lum",    F_FLOAT, hsl_lum[3],    -100.0f,     100.0f, N_("Colour mixer"), N_("Green luminance")),
    D("hsl.aqua.lum",     F_FLOAT, hsl_lum[4],    -100.0f,     100.0f, N_("Colour mixer"), N_("Aqua luminance")),
    D("hsl.blue.lum",     F_FLOAT, hsl_lum[5],    -100.0f,     100.0f, N_("Colour mixer"), N_("Blue luminance")),
    D("hsl.purple.lum",   F_FLOAT, hsl_lum[6],    -100.0f,     100.0f, N_("Colour mixer"), N_("Purple luminance")),
    D("hsl.magenta.lum",  F_FLOAT, hsl_lum[7],    -100.0f,     100.0f, N_("Colour mixer"), N_("Magenta luminance")),
    D("grade.shadow.hue", F_FLOAT, shadow_hue,       0.0f,     360.0f, N_("Grading"), N_("Shadow hue")),
    D("grade.shadow.sat", F_FLOAT, shadow_sat,    -100.0f,     100.0f, N_("Grading"), N_("Shadow strength")),
    D("grade.hilite.hue", F_FLOAT, hilite_hue,       0.0f,     360.0f, N_("Grading"), N_("Highlight hue")),
    D("grade.hilite.sat", F_FLOAT, hilite_sat,    -100.0f,     100.0f, N_("Grading"), N_("Highlight strength")),
    D("grade.balance",    F_FLOAT, grade_balance, -100.0f,     100.0f, N_("Grading"), N_("Balance")),
    D("sharpen",          F_FLOAT, sharpen,          0.0f,     150.0f, N_("Detail"), N_("Sharpening")),
    D("sharpen.radius",   F_FLOAT, sharpen_radius,   0.3f,       5.0f, N_("Detail"), N_("Radius")),
    D("nr.luma",          F_FLOAT, nr_luma,          0.0f,     100.0f, N_("Detail"), N_("Luminance noise")),
    D("nr.chroma",        F_FLOAT, nr_chroma,        0.0f,     100.0f, N_("Detail"), N_("Colour noise")),
    D("vignette",         F_FLOAT, vignette,      -100.0f,     100.0f, N_("Effects"), N_("Vignette")),
    D("vignette.mid",     F_FLOAT, vignette_mid,     0.0f,     100.0f, N_("Effects"), N_("Vignette midpoint")),
    D("vignette.feather", F_FLOAT, vignette_feather, 0.0f,     100.0f, N_("Effects"), N_("Vignette feather")),
    D("grain",            F_FLOAT, grain,            0.0f,     100.0f, N_("Effects"), N_("Grain")),
    D("grain.size",       F_FLOAT, grain_size,       0.0f,     100.0f, N_("Effects"), N_("Grain size")),
    D("lut",              F_STR,   lut,              0.0f,       0.0f, N_("LUT"), N_("LUT")),
    D("lut.amount",       F_FLOAT, lut_amount,       0.0f,     100.0f, N_("LUT"), N_("LUT strength")),
    D("crop",             F_INT,   crop.on,          0.0f,       1.0f, N_("Geometry"), N_("Crop")),
    D("crop.x",           F_FLOAT, crop.x,           0.0f,       1.0f, N_("Geometry"), N_("Crop left")),
    D("crop.y",           F_FLOAT, crop.y,           0.0f,       1.0f, N_("Geometry"), N_("Crop top")),
    D("crop.w",           F_FLOAT, crop.w,           0.0f,       1.0f, N_("Geometry"), N_("Crop width")),
    D("crop.h",           F_FLOAT, crop.h,           0.0f,       1.0f, N_("Geometry"), N_("Crop height")),
    D("crop.angle",       F_FLOAT, crop.angle,     -45.0f,      45.0f, N_("Geometry"), N_("Straighten")),
    D("flip.h",           F_INT,   flip_h,           0.0f,       1.0f, N_("Geometry"), N_("Flip horizontally")),
    D("flip.v",           F_INT,   flip_v,           0.0f,       1.0f, N_("Geometry"), N_("Flip vertically")),
    D("rotate90",         F_INT,   rotate90,         0.0f,       3.0f, N_("Geometry"), N_("Quarter turns")),
    D("curve.rgb",        F_CURVE, curve_rgb,        0.0f,       0.0f, N_("Curve"), N_("RGB curve")),
    D("curve.red",        F_CURVE, curve_r,          0.0f,       0.0f, N_("Curve"), N_("Red curve")),
    D("curve.green",      F_CURVE, curve_g,          0.0f,       0.0f, N_("Curve"), N_("Green curve")),
    D("curve.blue",       F_CURVE, curve_b,          0.0f,       0.0f, N_("Curve"), N_("Blue curve")),
};
