...
"  big transport forward | rewind\n"
"                          thirty seconds on or back. ⚠ SEEK, not skip: next\n"
"                          and prev move to the next TRACK, and on a disc to\n"
"                          the next CHAPTER\n"
...
"  big disc                what is in the optical drive: a Blu-ray, a DVD, an\n"
"                          audio CD, or nothing. A tile appears on the media\n"
"                          shelf while there is a disc, named after the disc\n"
"  big disc play           play it, full screen, through mpv — and the media\n"
"                          buttons then drive it, chapter skip included\n"
"  big disc eject          open the drive\n"
"       --drive=NODE       which one, when the machine has more than one\n"
"                          (default: the first with something playable in it)\n"
"                          ⚠ An encrypted commercial DVD needs libdvdcss and a\n"
"                          Blu-ray needs libaacs; neither is installed by\n"
"                          default and `big disc` says which is missing\n"
"  big record              start or stop a screen recording. synui's own\n"
"                          recorder — the same toggle super+shift+r is — so\n"
"                          there is one answer to whether this machine is\n"
"                          recording. The remote's Record button presses it\n"
...
"                          A television remote is read here too — the five\n"
"                          buttons no application can receive (OK, ⏭, ⏮,\n"
"                          Guide, Power) arrive as `remote:<word>`, and the\n"
"                          shell acts on them only while it is stepped aside.\n"
"                          ⚠ A HELD Start says `keyboard` as well as `menu`:\n"
"                          a press belongs to the application in front — in a\n"
"                          game it is the game's own menu — so the on-screen\n"
"                          keyboard opens on the hold\n"
